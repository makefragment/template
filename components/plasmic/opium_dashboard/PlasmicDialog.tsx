...
import Button from "../../Button"; // plasmic-import: ji6-7c0UJqLt/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: vgdY0K-oHhe6/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: BMYyZW6g83gg/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 0RFRFbiZZc8Z/icon
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_DCcWWQzxyLdR"]]: true })}
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__kMlnJ)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__g2B7Z)}
              >
                <div
                  className={classNames(
                    projectcss.all,
