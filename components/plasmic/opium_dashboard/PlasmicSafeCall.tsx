...
export type PlasmicSafeCall__VariantMembers = {};
export type PlasmicSafeCall__VariantsArgs = {};
...
function PlasmicSafeCall__RenderFunc(props: {
  variants: PlasmicSafeCall__VariantsArgs;
  args: PlasmicSafeCall__ArgsType;
  overrides: PlasmicSafeCall__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      <Button
        ...
        endIcon={
          <ChevronLeftIcon
            className={classNames(projectcss.all, sty.svg__uN9Yp)}
            role={"img"}
          />
        }
        onClick={async event => {
        ...
        startIcon={
          <ChevronRightIcon
            className={classNames(projectcss.all, sty.svg___2Bw84)}
            role={"img"}
          />
        }
      />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSafeCall__OverridesType,
  DescendantsType<T>
>;
