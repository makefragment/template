...
import Select__Option from "../../Select__Option"; // plasmic-import: cC7zdFUmFheB/component
...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: uyRQIX5cWWVm/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: C-JgjGWfRxfZ/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__sQmJ3)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__lTrdK)}
              />
            </React.Fragment>
          ),
          value: args.children
